...
dimer = {
    ...
    "A Label": "PRLD",
    "B Frag": 2,
    "B Ref Atoms": [[15],[16],[17]],
    "B Label": "Water",
    "Frozen": ["theta_A", "theta_B", "phi_A", "phi_B"],
}

psi4.set_memory("1.0 GB")
psi4.set_output_file('PRLD-DON-H1.out', False)
...
rAH = qcel.util.measure_coordinates(xyzs,[1,14],True) # in bohr
dih = qcel.util.measure_coordinates(xyzs,[11,1,14,15],True) # in degrees
